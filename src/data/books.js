export const books = [
    ...
    {
        id: 15,
        title: "Children of Anguish And Anarchy",
        img: "/products/15.jpg",
        author: "Tomi Adeyemi",
        description: "When Zelie seized the royal palace that fateful night, she thought her battles had come to an end. The monarchy had finally fallen. The maji had risen again. Zélie never expected to find herself locked in a cage and trapped on a foreign ship. Now warriors with iron skulls traffic her and her people across the seas, far from their homeland.",
        price: 9500,
        category: "Fiction"
    },
    {
    ...
    },
    {
        ...
        img: "/products/18.jpg",
        author: "Joseph Cox",
        description: "The inside story of the largest law-enforcement sting operation ever, in which the FBI made its own tech start-up to wiretap the world, shows how cunning both the authorities and drug traffickers have become, with privacy implications for everyone. In 2018, a powerful app for secure communications called Anom took root among organized criminals. They believed Anom allowed them to conduct business in the shadows. Except for one thing: it was secretly run by the FBI.        ",
        price: 15000,
        category: "Business"
    },
    {
