            ...
            <div className="flex flex-wrap md:px-8 px-6 py-[5%] md:gap-0 gap-12">
                <div className="md:w-[70%] w-full border border-transparent sm:text-[16px] text-[12px] md:border-r-[#DDD] md:pr-6">
                                        ...
                                        <tr key={book.id} className="">
                                            ...
                                            <td className="px-4">
                                                <div className=" flex items-center w-fit text-primary font-semibold items-start border border-[#262626]">
                                                    <button className="sm:text-lg sm:w-[40px] w-[20px] sm:h-[67px] h-[47px] bg-[#DDD]" onClick={() => handleQuantity(book.id, (book.quantity || 1) - 1)}>-</button>
                    ...
                    <div className="flex items-center justify-between gap-6 border border-transparent border-t-[#DDD] p-6">
                        <Link to={"/"} className="flex items-center gap-2 p-2 px-5 rounded-[10px] border-2 border-secondary text-secondary"> <ArrowIcon className={"md:w-[20px] w-[15px]"}/> Back to Shop</Link>
                        <button className="p-2 px-5 rounded-[10px] bg-secondary text-[#262626]">Update Cart</button>
                    </div>
                </div>
                ...
                <div className="md:w-[30%] w-full md:px-6 sm:text-[16px] text-[14px]">
                    ...
                    <button className="bg-secondary p-2 w-full rounded-[10px] text-[#262626] font-bold mb-4">Apply Coupon</button>
                    <Link to="/checkout" className="block text-center bg-secondary p-2 w-full rounded-[10px] text-[#262626] font-bold mb-4">Proceed To Check Out</Link>
                </div>
            </div>
        </>
    )
