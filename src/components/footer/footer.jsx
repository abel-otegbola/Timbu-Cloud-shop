    ...
    return (
        <footer className="flex flex-wrap md:gap-[5%] p-[7%] bg-primary text-white mt-4 gap-10">
            <div className="md:w-[20%] w-full flex flex-col gap-4">
                <h2 className="font-bold xl:text-[20px] text-lg">Our Address</h2>
                <div className="">
            ...
            <div className="flex flex-col gap-4 md:w-[30%] w-full">
                <h2 className="font-bold xl:text-[20px] text-lg">Join The Hybrid Worm</h2>
            ...
            <div className="md:w-[15%] w-full flex flex-col gap-4">
                <h2 className="font-bold xl:text-[20px] text-lg">More</h2>
                <div>
            ...
            <div className="md:w-[15%] w-full flex flex-col gap-4">
                <h2 className="font-bold xl:text-[20px] text-lg">Contact Us</h2>
                <div>
