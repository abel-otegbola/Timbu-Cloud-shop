        ...
        <nav className="flex items-center justify-between w-full px-6 py-3 overflow-hidden border border-transparent border-b-secondary">
            ...
            <div className={`flex lg:flex-row flex-col lg:gap-[8%] bg-white lg:justify-end flex-1 lg:shadow-none shadow-lg lg:p-0 p-[5%] lg:static fixed top-0 left-0 w-full h-full lg:items-center gap-8 duration-700 ${open ? "translate-x-0" : "lg:translate-x-0 translate-x-[150%]"}`}>
                <div className={`flex lg:flex-row flex-col lg:items-center font-semibold gap-2`}>
                    ...
                    <Link to={"/about-us"} className="p-4 py-2 hover:text-primary">About Us</Link>
                    <Link to={"/contact-us"} className="p-4 py-2 hover:text-primary">Contact Us</Link>
                    <Link to={"/subscription"} className="p-4 py-2 hover:text-primary">Subscription</Link>
